...
double calculate_static_charging_gain(const SolarCar& car, const Weather& weather, double weather_station,
...
std::optional<double> calculate_racetime(const SolarCar& car, const Route& route, const Weather& weather,
